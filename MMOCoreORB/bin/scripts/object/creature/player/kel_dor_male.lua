...
object_creature_player_kel_dor_male = object_creature_player_shared_kel_dor_male:new {
...
ObjectTemplates:addTemplate(object_creature_player_kel_dor_male, "object/creature/player/kel_dor_male.iff")
