...
object_creature_player_dug_male = object_creature_player_shared_dug_male:new {
...
ObjectTemplates:addTemplate(object_creature_player_dug_male, "object/creature/player/dug_male.iff")
