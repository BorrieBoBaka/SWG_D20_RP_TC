...
object_creature_player_chadra_fan_male = object_creature_player_shared_chadra_fan_male:new {
...
ObjectTemplates:addTemplate(object_creature_player_chadra_fan_male, "object/creature/player/chadra_fan_male.iff")
