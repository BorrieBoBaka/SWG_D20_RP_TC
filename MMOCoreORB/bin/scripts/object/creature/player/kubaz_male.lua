...
object_creature_player_kubaz_male = object_creature_player_shared_kubaz_male:new {
...
ObjectTemplates:addTemplate(object_creature_player_kubaz_male, "object/creature/player/kubaz_male.iff")
