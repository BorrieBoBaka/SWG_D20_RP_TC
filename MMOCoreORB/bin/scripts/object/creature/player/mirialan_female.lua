...
object_creature_player_mirialan_female = object_creature_player_shared_mirialan_female:new {
	...
	defaultLanguage = 1,
	startingItems = { },
	startingSkills = { "species_mirialan", "social_language_basic_comprehend", "social_language_basic_speak", "social_language_mirialan_comprehend", "social_language_mirialan_speak" }
}

ObjectTemplates:addTemplate(object_creature_player_mirialan_female, "object/creature/player/mirialan_female.iff")
