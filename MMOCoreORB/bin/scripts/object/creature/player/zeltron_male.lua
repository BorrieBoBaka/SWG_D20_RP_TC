...
object_creature_player_zeltron_male = object_creature_player_shared_zeltron_male:new {
...
ObjectTemplates:addTemplate(object_creature_player_zeltron_male, "object/creature/player/zeltron_male.iff")
