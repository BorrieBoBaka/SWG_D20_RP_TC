...
object_creature_player_arcona_male = object_creature_player_shared_arcona_male:new {
...
ObjectTemplates:addTemplate(object_creature_player_arcona_male, "object/creature/player/arcona_male.iff")
