object_draft_schematic_roleplay_weapon_lightsaber_sword_saber_maul_broke = object_draft_schematic_roleplay_weapon_lightsaber_shared_sword_saber_maul_broke:new {
	...
	targetTemplate = "object/weapon/roleplay/lightsaber/single/1h/sword_saber_maul_broke.iff",

	additionalTemplates = {}

}ObjectTemplates:addTemplate(object_draft_schematic_roleplay_weapon_lightsaber_sword_saber_maul_broke, "object/draft_schematic/roleplay/weapon/lightsaber/sword_saber_maul_broke.iff")
