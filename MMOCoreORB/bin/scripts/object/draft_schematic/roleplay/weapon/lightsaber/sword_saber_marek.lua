object_draft_schematic_roleplay_weapon_lightsaber_sword_saber_marek = object_draft_schematic_roleplay_weapon_lightsaber_shared_sword_saber_marek:new {
	...
	targetTemplate = "object/weapon/roleplay/lightsaber/single/1h/sword_saber_marek.iff",

	additionalTemplates = {}

}ObjectTemplates:addTemplate(object_draft_schematic_roleplay_weapon_lightsaber_sword_saber_marek, "object/draft_schematic/roleplay/weapon/lightsaber/sword_saber_marek.iff")
