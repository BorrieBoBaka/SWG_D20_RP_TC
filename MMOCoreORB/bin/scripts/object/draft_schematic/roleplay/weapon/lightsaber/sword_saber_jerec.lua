object_draft_schematic_roleplay_weapon_lightsaber_sword_saber_jerec = object_draft_schematic_roleplay_weapon_lightsaber_shared_sword_saber_jerec:new {
	...
	targetTemplate = "object/weapon/roleplay/lightsaber/single/1h/sword_saber_jerec.iff",

	additionalTemplates = {}

}ObjectTemplates:addTemplate(object_draft_schematic_roleplay_weapon_lightsaber_sword_saber_jerec, "object/draft_schematic/roleplay/weapon/lightsaber/sword_saber_jerec.iff")
