object_draft_schematic_roleplay_weapon_lightsaber_pole_lance_saber_champion = object_draft_schematic_roleplay_weapon_lightsaber_pole_shared_lance_saber_champion:new {
	...
	targetTemplate = "object/weapon/roleplay/lightsaber/double/lance_saber_champion.iff",

	additionalTemplates = {}

}ObjectTemplates:addTemplate(object_draft_schematic_roleplay_weapon_lightsaber_pole_lance_saber_champion, "object/draft_schematic/roleplay/weapon/lightsaber_pole/lance_saber_champion.iff")
