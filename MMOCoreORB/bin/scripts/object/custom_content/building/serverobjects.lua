...
includeFile("custom_content/building/military/serverobjects.lua")
includeFile("custom_content/building/mustafar/serverobjects.lua")
includeFile("custom_content/building/naboo/serverobjects.lua")
...
includeFile("custom_content/building/ship/serverobjects.lua")
