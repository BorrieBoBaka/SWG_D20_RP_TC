...
object_building_naboo_cloning_facility_naboo_empty = object_building_naboo_shared_cloning_facility_naboo_empty:new {
...
ObjectTemplates:addTemplate(object_building_naboo_cloning_facility_naboo_empty, "object/building/naboo/cloning_facility_naboo_empty.iff")
