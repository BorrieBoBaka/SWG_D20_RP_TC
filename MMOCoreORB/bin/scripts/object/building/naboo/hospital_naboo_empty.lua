...
object_building_naboo_hospital_naboo_empty = object_building_naboo_shared_hospital_naboo_empty:new {
	skillMods = {
...
ObjectTemplates:addTemplate(object_building_naboo_hospital_naboo_empty, "object/building/naboo/hospital_naboo_empty.iff")
