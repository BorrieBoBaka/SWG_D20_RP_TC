...
object_building_yavin_shared_dark_enclave_empty = SharedBuildingObjectTemplate:new {
	clientTemplateFileName = "object/building/yavin/shared_dark_enclave_empty.iff"
}
ObjectTemplates:addClientTemplate(object_building_yavin_shared_dark_enclave_empty, "object/building/yavin/shared_dark_enclave_empty.iff")
--******************************************************************************************************************************
object_building_yavin_shared_light_enclave_empty = SharedBuildingObjectTemplate:new {
	clientTemplateFileName = "object/building/yavin/shared_light_enclave_empty.iff"
}
ObjectTemplates:addClientTemplate(object_building_yavin_shared_light_enclave_empty, "object/building/yavin/shared_light_enclave_empty.iff")
--********************************************************************************************************************************
