...
object_tangible_wearables_bodysuit_shared_bodysuit_rodian_hunter = SharedTangibleObjectTemplate:new {
	clientTemplateFileName = "object/tangible/wearables/bodysuit/shared_bodysuit_rodian_hunter.iff"
}
